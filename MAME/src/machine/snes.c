...
static UINT8  spc_port_in[4];	/* Port for sending data to the SPC700 */
static UINT8  spc_port_out[4];	/* Port for receiving data from the SPC700 */
...
static void snes_load_sram(void)
{
	...
	battery_ram = (UINT8 *)osd_malloc( cart.sram_max );
	ptr = battery_ram;
