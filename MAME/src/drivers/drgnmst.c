...
ROM_START( drgnmst )
	...
	ROM_LOAD16_BYTE( "dm1000e", 0x00000, 0x80000, 0x29467dac )
	ROM_LOAD16_BYTE( "dm1000o", 0x00001, 0x80000, 0xba48e9cf )

	ROM_REGION( 0x10000, REGION_CPU2, 0 ) /* PIC16c55 Code */
	ROM_LOAD( "pic16c55", PIC16C55_PGM_OFFSET, 0x400, 0x531c9f8d )

	ROM_REGION( 0x140000, REGION_SOUND1, 0 ) /* OKI-0 Samples */
	ROM_LOAD( "dm1001", 0x00000, 0x100000, 0x63566f7f )

	ROM_REGION( 0x200000, REGION_SOUND2, 0 ) /* OKI-1 Samples */
	ROM_LOAD( "dm1002", 0x00000, 0x200000, 0x0f1a874e )

	ROM_REGION( 0x800000, REGION_GFX1, 0 ) /* Sprites (16x16x4) */
	ROM_LOAD16_BYTE( "dm1003", 0x000000, 0x080000, 0x0ca10e81 )
	ROM_CONTINUE(0x400000, 0x080000)
	ROM_CONTINUE(0x100000, 0x080000)
	ROM_CONTINUE(0x500000, 0x080000)
	ROM_LOAD16_BYTE( "dm1005", 0x000001, 0x080000, 0x4c2b1db5 )
	ROM_CONTINUE(0x400001, 0x080000)
	ROM_CONTINUE(0x100001, 0x080000)
	ROM_CONTINUE(0x500001, 0x080000)
	ROM_LOAD16_BYTE( "dm1004", 0x200000, 0x040000, 0x1a9ac249 )
	ROM_CONTINUE(0x600000, 0x040000)
	ROM_LOAD16_BYTE( "dm1006", 0x200001, 0x040000, 0xc46da6fc )
	ROM_CONTINUE(0x600001, 0x040000)

	ROM_REGION( 0x200000, REGION_GFX2, 0 ) /* BG Tiles (8x8x4, 16x16x4 and 32x32x4) */
	ROM_LOAD16_BYTE( "dm1007", 0x000001, 0x100000, 0xd5ad81c4 )
	ROM_LOAD16_BYTE( "dm1008", 0x000000, 0x100000, 0xb8572be3 )
ROM_END
