...
ROM_START( dragrace )
	...
	ROM_LOAD( "8513.c1", 0x1000, 0x0800, 0x543BBB30 )
	ROM_LOAD( "8514.a1", 0x1800, 0x0800, 0xAD218690 )
	ROM_RELOAD(          0xF800, 0x0800 )

	ROM_REGION( 0x800, REGION_GFX1, ROMREGION_DISPOSE )   /* 2 color tiles */
	ROM_LOAD( "8519dr.j0", 0x000, 0x200, 0xaa221ba0 )
	ROM_LOAD( "8521dr.k0", 0x200, 0x200, 0x0cb33f12 )
	ROM_LOAD( "8520dr.r0", 0x400, 0x200, 0xee1ae6a7 )

	ROM_REGION( 0x800, REGION_GFX2, ROMREGION_DISPOSE )   /* 4 color tiles */
	ROM_LOAD( "8515dr.e0", 0x000, 0x200, 0x9510a59e )
	ROM_LOAD( "8517dr.h0", 0x200, 0x200, 0x8b5bff1f )
	ROM_LOAD( "8516dr.l0", 0x400, 0x200, 0xd1e74af1 )
	ROM_LOAD( "8518dr.n0", 0x600, 0x200, 0xb1369028 )
ROM_END
