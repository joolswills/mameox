...
BOOL CSkin::LoadSkin( CStdString *errorReport )
{
  ...
  CSystem_IniFile iniFile( fullIniFilePath );
	...
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_MANUFACTURER_DIVIDER,		CSkinDivider, "Header.Verbose.Manufacturer" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_YEAR_DIVIDER,						CSkinDivider, "Header.Verbose.Year" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NUMPLAYERS_DIVIDER,			CSkinDivider, "Header.Verbose.NumPlayers" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_CLONE_DIVIDER,						CSkinDivider, "Header.Verbose.Clone" );
