...
BOOL CSkin::LoadSkin( CStdString *errorReport )
{
  ...
  CSystem_IniFile iniFile( fullIniFilePath );
	...
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NAME_TEXT,								CSkinText, "TitleBar.Verbose.Name" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_MANUFACTERER_TEXT,				CSkinText, "TitleBar.Verbose.Manufacturer" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_YEAR_TEXT,								CSkinText, "TitleBar.Verbose.Year" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NUMPLAYERS_TEXT,					CSkinText, "TitleBar.Verbose.NumPlayers" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_CLONE_TEXT,							CSkinText, "TitleBar.Verbose.Clone" );

	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_MANUFACTURER_DIVIDER,		CSkinDivider, "TitleBar.Verbose.Manufacturer" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_YEAR_DIVIDER,						CSkinDivider, "TitleBar.Verbose.Year" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NUMPLAYERS_DIVIDER,			CSkinDivider, "TitleBar.Verbose.NumPlayers" );
	PARSESUBITEM(			SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_CLONE_DIVIDER,						CSkinDivider, "TitleBar.Verbose.Clone" );
	...
	PARSESUBITEM(			SKINELEMENT_OPTIONSSCREEN_HEADER_DIVIDER,															CSkinDivider, "TitleBar" );
