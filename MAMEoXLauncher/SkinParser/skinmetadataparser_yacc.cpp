...
/*  A Bison parser, made from skinmetadataparser.y with Bison version GNU Bison version 1.24
  */

#define YYBISON 1  /* Identify Bison output.  */

#define yyparse smpparse
#define yylex smplex
#define yyerror smperror
#define yylval smplval
#define yychar smpchar
#define yydebug smpdebug
#define yynerrs smpnerrs
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 274 ? yytranslate[x] : 24)
...
static const short yyprhs[] = {     0,
     0,     4,     9,    10,    15,    20,    25,    28,    29
};

static const short yyrhs[] = {     8,
    21,     9,     0,    21,    10,    22,    11,     0,     0,    22,
    12,     4,    13,     0,    22,    14,     4,    15,     0,    22,
    16,     4,    17,     0,    22,    23,     0,     0,    18,     6,
    19,     0
};
...
static const short yyrline[] = { 0,
   100,   104,   104,   112,   112,   113,   114,   115,   119
};

static const char * const yytname[] = {   "$","error","$undefined.","_TOK_IDENTIFIER_",
"_TOK_STRING_","_TOK_MACROSET_","_TOK_FILENAME_","_TOK_INT_","SKIN_OPEN","SKIN_CLOSE",
"METADATA_OPEN","METADATA_CLOSE","AUTHOR_OPEN","AUTHOR_CLOSE","NAME_OPEN","NAME_CLOSE",
"DESCRIPTION_OPEN","DESCRIPTION_CLOSE","PREVIEWFILE_OPEN","PREVIEWFILE_CLOSE",
"start_symbol","skin","metadata","metadata_previewfile",""
};
#endif
...
-32768,    -1,-32768,-32768,   -11,-32768,     0,     2,     6,     5,
-32768,     1,    -3,    -4,    -2,-32768,-32768,-32768,-32768,    15,
    16,-32768
};
...
static const short yytable[] = {     6,
     7,     1,     8,    12,     9,    13,    10,     3,     4,    14,
    15,    17,    18,    16,    21,    22,    19
};

static const short yycheck[] = {    11,
    12,     8,    14,     4,    16,     4,    18,     9,    10,     4,
     6,    15,    17,    13,     0,     0,    19
};
...
{;
    break;}
case 4:
{ g_parserSkinObject->m_author = yyvsp[-1].stringVal; SkinMetadataParserDeleteString( yyvsp[-1].stringVal ); ;
    break;}
case 5:
{ g_parserSkinObject->m_name = yyvsp[-1].stringVal; SkinMetadataParserDeleteString( yyvsp[-1].stringVal ); ;
    break;}
case 6:
{ g_parserSkinObject->m_description = yyvsp[-1].stringVal; SkinMetadataParserDeleteString( yyvsp[-1].stringVal ); ;
    break;}
case 8:
{;
    break;}
case 9:
{
													...
													{														 
														smperror( CStdString("Failed to load preview file ") + yyvsp[-1].stringVal );
														SkinMetadataParserDeleteString( yyvsp[-1].stringVal );
														CLEAN_AND_DIE();
													}
