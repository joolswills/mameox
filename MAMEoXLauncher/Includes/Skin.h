...
typedef enum SkinElementID_t {
	...
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NAME_TEXT,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_MANUFACTERER_TEXT,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_YEAR_TEXT,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NUMPLAYERS_TEXT,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_CLONE_TEXT,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_MANUFACTURER_DIVIDER,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_YEAR_DIVIDER,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_NUMPLAYERS_DIVIDER,
	SKINELEMENT_ROMLISTSCREEN_HEADER_VERBOSE_CLONE_DIVIDER,
	...
	SKINELEMENT_OPTIONSSCREEN_HEADER_DIVIDER,
...
public:
  ...
  BOOL LoadSkin( CStdString *errorReport );
	...
	inline const CSkinProgressbar *GetSkinElementProgressbar( SkinElementID_t id ) const { 
		...
		//------------------------------------------------------
		// GetSkinElementDivider
		//------------------------------------------------------
	inline const CSkinDivider *GetSkinElementDivider( SkinElementID_t id ) const { 
		CHECK_CAST( m_spriteElementArray[id], SKINELEMENT_DIVIDER );
		return (CSkinDivider*)m_spriteElementArray[id]; 
	}
