...
#define ASSET_BUTTON_TOPROW_BOTTOM      32.0f
#define ASSET_BUTTON_BOTTOMROW_TOP      32.0f
#define ASSET_BUTTON_BOTTOMROW_BOTTOM   64.0f

#define ASSET_BUTTON_LEFTCOLUMN_LEFT    0.0f
#define ASSET_BUTTON_LEFTCOLUMN_RIGHT   32.0f
#define ASSET_BUTTON_RIGHTCOLUMN_LEFT   32.0f
#define ASSET_BUTTON_RIGHTCOLUMN_RIGHT  64.0f

#define ASSET_BUTTONICON_START_LEFT     64.0f
#define ASSET_BUTTONICON_START_TOP      0.0f
#define ASSET_BUTTONICON_START_RIGHT    94.0f
