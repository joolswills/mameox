...
print GENERATEDFILE "      _RPT2( _CRT_WARN, \"Driver %s [CODE]: %lu\\n\", (*i).first.c_str(), sz );\n";
print GENERATEDFILE "    }\n";
...
print GENERATEDFILE "      _RPT2( _CRT_WARN, \"Driver %s [DATA]: %lu\\n\", (*i).first.c_str(), sz );\n";
print GENERATEDFILE "    }\n";
print GENERATEDFILE "    else\n";
print GENERATEDFILE "      PRINTMSG( T_ERROR, \"Invalid section %s for file %s!\", (*i).second.c_str(), (*i).first.c_str() );\n";
print GENERATEDFILE "\n";
...
print GENERATEDFILE "      _RPT2( _CRT_WARN, \"Driver %s [BSS]: %lu\\n\", (*i).first.c_str(), sz );\n";
print GENERATEDFILE "    }\n";
print GENERATEDFILE "    else\n";
print GENERATEDFILE "    {\n";
print GENERATEDFILE "      PRINTMSG( T_ERROR, \"Invalid section %s for file %s!\", (*i).second.c_str(), (*i).first.c_str() );\n";
...
print GENERATEDFILE "  sectionName = DATA_PREFIX;\n";
print GENERATEDFILE "  sectionName += (*i).second.c_str();\n";
print GENERATEDFILE "  _RPT2( _CRT_WARN, \"LoadDriverSectionByName %s = %s\\n\", DriverFileName, (*i).second.c_str() );\n";
