...
NameQueryPacket::NameQueryPacket(const char* name, uint8 broadcast, uint16 id, uint8 status, bool groupFlag)

{
...

	{
		...
		nmFlags=(broadcast&1); qdcount=1;

		questionType=0x21; questionClass=1;
